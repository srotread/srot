...
const Button: FC<ButtonProps> = ({
  ...
  if (type === "Primary") {
    return (
      <button
        className={`rounded bg-accent py-2 px-3 text-dark shadow-btn-accent transition-all focus:ring disabled:cursor-not-allowed ${
          theme === "Light"
      ...
      >
        {!loading ? (
          ...
          <div role="status">
            <svg
              aria-hidden="true"
              className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-200 fill-dark"
              viewBox="0 0 100 101"
              fill="none"
